...
import { getClientTypes } from '../functions';
    ...
    return (
        <>
            <div className="container">
                <div className="row">
                    <div className="col">
                        <h1>{id == 0 ? "Add" : "Edit"} Client</h1>
                    </div>
                    <div className="col text-end mt-2">
                        <Link to={`/client/${id}`} className="btn btn-light border me-2">
                    ...
                    <div className="row mb-2">
                        <div className="col">
                            <div className="mb-3">
                                ...
                                <input id="name" type="text" className="form-control required" aria-label="Name" value={data.name ?? ''} required
                                    onChange={(e) =>
                                        setData({
                                            ...data,
                                            name: e.target.value,
                            ...
                            <div className="mb-3">
                                <label htmlFor="typeId" className="form-label">Client Type</label>
