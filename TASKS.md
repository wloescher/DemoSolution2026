...
- [x] Check the capture script into the repo as `npm run screenshots` (`scripts/screenshots.mjs`),
      starting/stopping each dev server itself so regeneration is a single command
